...
class CuentoBosque : Fragment() {
    ...
    private val args: CuentoBosqueArgs by navArgs()
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.cuento_bosque, container, false)
        val textView = view.findViewById<TextView>(R.id.contenido)
        val button = view.findViewById<Button>(R.id.returnHome)


        fetchStory("bosque maldito", textView)

        button.setOnClickListener {
            val action = R.id.action_cuentoBosque_to_cuentoStart
